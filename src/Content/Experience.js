export const ExperienceContent = [
  ...
  },
  {
    ...
    brief: [
      "Optimized a React.js micro-frontend architecture, resolving over 19 issues to enhance optimization and responsiveness. These improvements significantly increased the performance by 56%.",
      "Developed over 30 generic micro-components for an npm package contributing to the internal library. Revamped over 10 pages of Zluri.com using Gatsby and integrated them with GraphQL, leveraging Contentful CMS to optimize performance by 67%."
    ],
  },
  {
    company: "Websoot",
